...
<header>
    ...
    <div class="navbar navbar-dark bg-dark shadow-sm">
        ...
        <button class="btn btn-secondary" href="validation.jsp">
                ...
                <div class="col">
                    ...
                    <div class="card shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Количестко: ${item.inStock} штук</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="btn-group">
                                    <form action="description-item" method="post">
                                        <button type="submit" class="btn btn-sm btn-outline-secondary"
                                                name="description" value="${item.idItem}">Подробнее
                                        </button>
                                    </form>
